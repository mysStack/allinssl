...
func (r fakeZoneReader) SetRecordLoadBalancing(context.Context, string, string, dnsmodel.Record) error {
	return nil
}
func (r fakeZoneReader) SetRecordRemark(context.Context, string, string) error { return nil }
