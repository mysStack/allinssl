...
export const createDNSController = (gateway: DNSGateway) => {
	...
	return { credentials, zones, snapshot, credentialID, zone, loading, error, credentialOptions, zoneOptions, recordFilters, visibleRecords, setRecordSort, refreshCredentials, refreshZones, refreshSnapshot, setZone }
}
